                ...
                <div>
                    <form onSubmit={handleSubmitForm} className='flex flex-col gap-6'>
                        <input
                            ...
                            type="text" name="firstName" id="" placeholder='First Name' autoFocus className='px-1 focus:border-green1 placeholder:text-accent placeholder:text-gray1 rounded  py-2 w-3/4 outline-0 border border-gray1' />
                        <input
                            value={userInfo.lastName}
                            onChange={handleChange}
                            type="text" name="lastName" id="" placeholder='Last Name' className='px-1 focus:border-green1 placeholder:text-accent placeholder:text-gray1 rounded  py-2 w-3/4 outline-0 border border-gray1' />
                        <input
                            value={userInfo.email}
                            onChange={handleChange}
                            type="email" name="email" id="" placeholder='Email' className='px-1 focus:border-green1 placeholder:text-accent placeholder:text-gray1 rounded  py-2 w-3/4 outline-0 border border-gray1' />
                        <input
                            value={userInfo.password}
                            onChange={(e) => setUserInfo({ ...userInfo, password: e.target.value })}
                            type="password" name="password" id="" placeholder='Password' className='px-1 focus:border-green1 placeholder:text-accent placeholder:text-gray1 rounded  py-2 w-3/4 outline-0 border border-gray1' />
