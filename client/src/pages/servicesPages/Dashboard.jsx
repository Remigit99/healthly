        ...
        <div className="flex gap-4 overflow-x-auto pb-2 no-scrollbar">
          {children.map((child) => (
            ...
            >
              ...
              <div>
                <p className="font-black text-slate-800 leading-none mb-1">{child.firstName} {child.lastName}</p>
                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">{age(child.dateOfBirth)} Years</p>
              </div>
            </motion.div>
          ))}
        </div>
